...
Wygwam.loadEEFileBrowser = function(params, directory, content_type) {
	var $trigger = $('<trigger rel="modal-file" href="' + Wygwam.fpUrl + '" />');
	...
	// EE FilePicker modal is really shy and does not want to show itself.
	$('.modal-file').removeClass('hidden').show().css({position: 'fixed', 'z-index': 10011});

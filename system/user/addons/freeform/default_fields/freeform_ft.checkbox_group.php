...
class Checkbox_group_freeform_ft extends Freeform_base_ft
{
	...
	{
		return $this->multi_item_row($data, $this->short_name);
	}
	...
	{
		return $this->validate_multi_item_row_settings($data, $this->short_name);
	}
	...
	{
		return $this->save_multi_item_row_settings($data, $this->short_name);
	}
	//END save_settings
	...
	public function display_field ($data = '', $params = array(), $attr = array())
	{
		...
		$list_items	= $this->get_field_options($this->short_name);
	...
	public function validate ($data)
	{
		...
		// If any of the incoming data does not
		// exist as a key in the options array, fail.
		$opts	= $this->get_field_options($this->short_name, FALSE);
	...
	{
		return $this->multi_item_replace_tag($data, $tagdata, $this->short_name, $params);
	}
	//END replace tag
	...
	{
		return $this->display_multi_item_output($data, true, $this->short_name);
	}
	...
	{
		return $this->save_multi_item($data, $this->short_name);
	}
	//END save
	...
	{
		return $this->display_multi_item_output($data, FALSE, $this->short_name);
	}
	//END export
}

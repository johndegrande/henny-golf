...
//%pro%
		'spam_keyword_ban_enabled'		=> array(
			'type'		=> 'yes_no',
			'value'		=> 'n',
			'validate'	=> 'enum[y,n]'
		),
		...
		'spam_keyword_ban_message'		=> array(
			'type'		=> 'text',
			'value'		=> 'Invalid Entry Data',
			'validate'	=> ''
		),
		'form_statuses'					=> array(
			'type'		=> 'html',
...
//%pro%
		'multi_form_timeout'			=> array(
			'type'		=> 'text',
			'value'		=> 10800,
			'validate'	=> 'number'
		),
		'keep_unfinished_multi_form'	=> array(
			'type'		=> 'yes_no',
			'value'		=> 'n',
			'validate'	=> 'enum[y,n]'
		),
...
//%/pro%
	...
	public function set_preferences($new_prefs = array())
	{
		...
		ee()->db->where_in('site_id', array_keys($prefs));

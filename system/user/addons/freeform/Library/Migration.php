...
class Migration extends AddonBuilder
{
	public $cache_path;
	...
	public function create_field ($form_id = '', $field_name = '', $field_attr = array())
	{
		...
		$field_instance =& $this->lib('Fields')->get_fieldtype_instance($field_type);
	...
	public function create_upload_field ($form_id = '', $field_name = '', $field_attr = array())
	{
		...
		$row = $this->model('field')->get_row(array(
			'field_name' => $field_name
		));
	...
	public function get_field_type_installed($field_type = '')
	{
		...
		$this->model('fieldtype')->clear_cache();

		$field_types = $this->model('fieldtype')->installed_fieldtypes();
